...
C *********************************************************
C *                                                       *
C * Calculate the element contribution and assembly the   *s
...
!
       ...
       write(17,*) 
       write(17,*) 'Ïß»ý·ÖÖ®ºÍ',line_sum
       write(17,*) 'Ãæ»ý·ÖF1Ö®ºÍ',Area1_sum
       write(17,*) 'Ãæ»ý·ÖF2Ö®ºÍ',Area2_sum
       write(17,*) 'Ãæ»ý·ÖF0Ö®ºÍ',Area0_sum
       write(17,*) 'Ãæ»ý·ÖÖ®ºÍ',Area_sum
       write(17,*) ' »ý·ÖÖ®ºÍ',Area_sum+Line_sum
!
!
!500     CONTINUE
...
!         STOP!!this can stop ipython,seems
        RETURN
        END
