...
! **ŒÆËã  JK1=Jk1C*cos£štheta£©+Jk1S*sin£štheta£© ------ (C12)
...
! **ŒÆËãN0£¬N1=N1C*cos£štheta£©+N1S*sin£štheta£©   (C13)
...
!                                  
      ...
      write(17,*) '        Ïß»ý·Ö        ',FITG

!
! ======================================================================
!
! ** 1000Ñ­»·ŒÆËãË«ÖØ»ý·ÖÖÐº¯Êý£šF2/plo/plo+F1/plo£©Ïî»ý·Ö
...
!C
         ...
         write(17,*)
         write(17,*) '       Ãæ»ý·Ö F1/plo=    ',totf_1
         write(17,*) '       Ãæ»ý·Ö F2/plo/plo=',totf_2
         write(17,*) '       Ãæ»ý·Ö F=',totF
         write(17,*) '       Ãæ»ý·Ö F-F2/plo/plo+F1/plo=',totF-tot
         write(17,*)
...
! --------------------------------------------
!
!**  Ïß»ý·ÖÖÐsum1ÓŠÎª0£¬ sum2ÓŠÎª2*Pi    
